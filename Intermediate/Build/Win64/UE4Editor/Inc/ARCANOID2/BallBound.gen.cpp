...
// Cross Module References
	ARCANOID2_API UClass* Z_Construct_UClass_ABallBound_NoRegister();
	ARCANOID2_API UClass* Z_Construct_UClass_ABallBound();
...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABallBound_OnOverlapBegin_Statics::NewProp_OverlappeComp_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ABallBound_OnOverlapBegin_Statics::NewProp_OverlappeComp = { "OverlappeComp", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(BallBound_eventOnOverlapBegin_Parms, OverlappeComp), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ABallBound_OnOverlapBegin_Statics::NewProp_OverlappeComp_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ABallBound_OnOverlapBegin_Statics::NewProp_OverlappeComp_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABallBound_OnOverlapBegin_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABallBound_OnOverlapBegin_Statics::NewProp_OverlappeComp,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABallBound_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABallBound_OnOverlapBegin, "OnOverlapBegin" }, // 2832721669
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ABallBound, 2109960050);
	template<> ARCANOID2_API UClass* StaticClass<ABallBound>()
	{
		return ABallBound::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABallBound(Z_Construct_UClass_ABallBound, &ABallBound::StaticClass, TEXT("/Script/ARCANOID2"), TEXT("ABallBound"), false, nullptr, nullptr, nullptr);
